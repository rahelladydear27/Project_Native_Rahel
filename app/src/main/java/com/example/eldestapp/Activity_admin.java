...
public class Activity_admin extends AppCompatActivity implements Adaptor.DataChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Activity_admin.this, SimpanData.class); // Start SimpanData activity
    ...
    private void loadData() {
        String url = new Configurasi().baseUrl() +"admin/tampil_data_admin.php";
        ...
        StringRequest request = new StringRequest(
                            ...
                            if (jsonObject.has("data")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    model.add(new GetData(
                                            getData.getString("id_admin"),
                                            getData.getString("nama"),
                                            getData.getString("alamat"),
                                            getData.getString("nomor_hp")
                                    ));
                                }

                                adaptor = new Adaptor(Activity_admin.this, model, progressBar, Activity_admin.this);
                                listView.setAdapter(adaptor);
                                Log.d("Activity_admin", "Data loaded successfully");
                            } else {
                                Log.e("Activity_admin", "JSON does not contain 'data' key");
                                Toast.makeText(Activity_admin.this, "Invalid data format", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Log.e("Activity_admin", "JSON Parsing error: " + e.getMessage());
                            Toast.makeText(Activity_admin.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(Activity_admin.this, "Terjadi kesalahan saat memuat data", Toast.LENGTH_SHORT).show();
                        // Reload data on error
                        reloadData();
                    }
                });
