...
public class EditDataKategori extends AppCompatActivity {

    private EditText editnama_sepeda, editkapasitas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editnama_sepeda = findViewById(R.id.uploadnama);
        editkapasitas=findViewById(R.id.uploadalamat);
    ...
    private void updateData() {
        ...
        final String kapasitas = editkapasitas.getText().toString().trim();



        // Validasi input
        if (nama_sepeda.isEmpty() || kapasitas.isEmpty()) {
            Toast.makeText(EditDataKategori.this, "Harap isi semua kolom", Toast.LENGTH_SHORT).show();
            return;
        }

        // URL untuk skrip PHP yang akan melakukan update data
        String url = new Configurasi().baseUrl() + "kategori/edit.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(EditDataKategori.this, "Data berhasil diperbarui", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(EditDataKategori.this, "Gagal memperbarui data", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
