...
public class EditDataPencatatan extends AppCompatActivity {
    ...
    String id_pencatatan;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_pencatatan);
        ...
        if (intent != null) {
            id_pencatatan = intent.getStringExtra("id_pencatatan");
            ...
            uploadnama_lokasi.setText(intent.getStringExtra("nama_lokasi"));
            uploadNama_sepeda.setText(intent.getStringExtra("nama_sepeda"));
            uploadNomor_hp_pemesan.setText(intent.getStringExtra("nomor_hp_pemesan"));
            uploadjumlah.setText(intent.getStringExtra("jumlah_pemesanan"));
        }
...
//                    Toast.makeText(EditDataPencatatan.this, "Nama Hutang: " + item, Toast.LENGTH_SHORT).show();
                }
            }
            @Override
...
//                    Toast.makeText(EditDataPencatatan.this, "Nama Sepeda: " + item, Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
    ...
    private void simpanData() {
        ...
        final String Id_pencatatan = id_pencatatan ;
        ...
        String url = new Configurasi().baseUrl() + "pencatatan/edit.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(EditDataPencatatan.this, "Data berhasil diedit", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(EditDataPencatatan.this, "Gagal menyimpan data", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("id_pencatatan", Id_pencatatan);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    adapterNama_petugas = new ArrayAdapter<>(EditDataPencatatan.this, android.R.layout.simple_spinner_item, nama_petugasList);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    adapterNama_lokasi = new ArrayAdapter<>(EditDataPencatatan.this, android.R.layout.simple_spinner_item, nama_lokasiList);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    adapterNama_sepeda = new ArrayAdapter<>(EditDataPencatatan.this, android.R.layout.simple_spinner_item, nama_sepedaList);
