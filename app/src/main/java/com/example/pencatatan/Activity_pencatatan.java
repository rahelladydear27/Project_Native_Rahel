...
import com.example.pencatatan.AdaptorPencatatan;
...
public class Activity_pencatatan extends AppCompatActivity implements AdaptorPencatatan.DataChangeListener {
    ...
    private AdaptorPencatatan adaptor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Activity_pencatatan.this, SimpanDataPencatatan.class); // Start SimpanData activity
        ...
        StringRequest request = new StringRequest(
                        ...
                        try {
                            ...
                            if (jsonObject.has("data")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    model.add(new GetDataPencatatan(
                                            getData.getString("id_pencatatan"),
                                            getData.getString("nama_petugas"),
                                            getData.getString("nama_lokasi"),
                                            getData.getString("nama_sepeda"),
                                            getData.getString("nama_pemesan"),
                                            getData.getString("nomor_hp_pemesan"),
                                            getData.getString("jumlah_pemesanan"),
                                            getData.getString("mulai_sewa")
                                    ));
                                }

                                adaptor = new AdaptorPencatatan(Activity_pencatatan.this, model, progressBar, Activity_pencatatan.this);
                                listView.setAdapter(adaptor);
                                Log.d("Activity_admin", "Data loaded successfully");
                            } else {
                                Log.e("Activity_admin", "JSON does not contain 'data' key");
                                Toast.makeText(Activity_pencatatan.this, "Invalid data format", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Log.e("Activity_admin", "JSON Parsing error: " + e.getMessage());
                            Toast.makeText(Activity_pencatatan.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(Activity_pencatatan.this, "Terjadi kesalahan saat memuat data", Toast.LENGTH_SHORT).show();
                        // Reload data on error
                        reloadData();
                    }
                });
