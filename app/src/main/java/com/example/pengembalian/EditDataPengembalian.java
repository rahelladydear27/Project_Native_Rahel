...
public class EditDataPengembalian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_pengembalian);
        ...
        if (intent != null) {
            id_pengembalian = intent.getStringExtra("id_pengembalian");
            uploadNama_pemesan.setText(intent.getStringExtra("nama_pemesan"));
            uploadNama_sepeda.setText(intent.getStringExtra("nama_sepeda"));
            uploadJenis_pembayaran.setText(intent.getStringExtra("jenis_pembayaran"));
            uploadNama_sepeda.setText(intent.getStringExtra("nama_sepeda"));
            uploadNama_petugas.setText(intent.getStringExtra("nama_petugas"));
            uploadHarga.setText(intent.getStringExtra("harga"));
        }
...
//                    Toast.makeText(EditDataPengembalian.this, "Nama Hutang: " + item, Toast.LENGTH_SHORT).show();
                }
            }
            @Override
...
//                    Toast.makeText(EditDataPengembalian.this, "Nama Sepeda: " + item, Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
...
//                    Toast.makeText(EditDataPengembalian.this, "Petugas: " + item, Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
    ...
    private void simpanData() {
        ...
        String url = new Configurasi().baseUrl() + "pengembalian/edit.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(EditDataPengembalian.this, "Data berhasil disimpan", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(EditDataPengembalian.this, "Gagal menyimpan data", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("id_pengembalian", id_pengembalian);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    adapterNama_pemesan = new ArrayAdapter<>(EditDataPengembalian.this, android.R.layout.simple_spinner_item, nama_pemesanList);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    adapterNama_sepeda = new ArrayAdapter<>(EditDataPengembalian.this, android.R.layout.simple_spinner_item, nama_sepedaList);
...
//                        String id = jsonObject.optString("id_pencatatan");
                    ...
                    adapterJenis_pembayaran = new ArrayAdapter<>(EditDataPengembalian.this, android.R.layout.simple_spinner_item, jenis_pembayaranList);
...
//                            String id = jsonObject.optString("id_petugas");
                    ...
                    adapterNama_petugas = new ArrayAdapter<>(EditDataPengembalian.this, android.R.layout.simple_spinner_item, nama_petugasList);
