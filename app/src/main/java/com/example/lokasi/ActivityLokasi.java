...
public class ActivityLokasi extends AppCompatActivity implements AdaptorLokasi.DataChangeListener {
    ...
    private ArrayList<GetDataLokasi> model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ActivityLokasi.this, SimpanDataLokasi.class); // Start SimpanData activity
        ...
        StringRequest request = new StringRequest(
                        ...
                        try {
                            ...
                            if (jsonObject.has("data")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    JSONObject getDataLokasi = jsonArray.getJSONObject(i);
                                    model.add(new GetDataLokasi(
                                            getDataLokasi.getString("id_lokasi"),
                                            getDataLokasi.getString("nama_lokasi"),
                                            getDataLokasi.getString("alamat")
                                    ));
                                }

                                adaptor = new AdaptorLokasi(ActivityLokasi.this, model, progressBar, ActivityLokasi.this);
                                listView.setAdapter(adaptor);
                                Log.d("Activity_admin", "Data loaded successfully");
                            } else {
                                Log.e("Activity_admin", "JSON does not contain 'data' key");
                                Toast.makeText(ActivityLokasi.this, "Invalid data format", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Log.e("Activity_admin", "JSON Parsing error: " + e.getMessage());
                            Toast.makeText(ActivityLokasi.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(ActivityLokasi.this, "Terjadi kesalahan saat memuat data", Toast.LENGTH_SHORT).show();
                        // Reload data on error
                        reloadData();
                    }
                });
