...
public class AdaptorLokasi extends RecyclerView.Adapter<AdaptorLokasi.ViewHolder> {
    ...
    public AdaptorLokasi(Context context, ArrayList<GetDataLokasi> model, ProgressBar progressBar, DataChangeListener dataChangeListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        GetDataLokasi data = model.get(position);
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, EditDataLokasi.class);
                intent.putExtra("id_lokasi", data.getId_lokasi());
        ...
        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                deleteData(data.getId_lokasi(), position);
            }
        });
    }
    ...
    private void deleteData(final String id_lokasi, final int position) {
        String url = new Configurasi().baseUrl() + "lokasi/hapus.php";
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView nama_lokasi, alamat;
        ImageButton editButton, deleteButton;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            nama_lokasi = itemView.findViewById(R.id.nama);
