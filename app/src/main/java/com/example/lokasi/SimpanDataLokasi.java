...
public class SimpanDataLokasi extends AppCompatActivity {
    ...
    private void simpanData() {
        ...
        final String nama_lokasi = uploadNama.getText().toString().trim();
        final String alamat_lokasi = alamat.getText().toString().trim();


        // Validasi input
        if (nama_lokasi.isEmpty()|| alamat_lokasi.isEmpty()) {
            Toast.makeText(SimpanDataLokasi.this, "Harap isi semua kolom", Toast.LENGTH_SHORT).show();
            return;
        }

        // URL untuk skrip PHP yang akan menyimpan data
        String url = new Configurasi().baseUrl() + "lokasi/tambah.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(SimpanDataLokasi.this, "Data berhasil disimpan", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SimpanDataLokasi.this, "Gagal menyimpan data", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("alamat", alamat_lokasi);
