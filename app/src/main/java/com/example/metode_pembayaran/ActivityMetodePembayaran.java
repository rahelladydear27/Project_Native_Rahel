...
public class ActivityMetodePembayaran extends AppCompatActivity implements AdaptorMetodePembayaran.DataChangeListener {
    ...
    private AdaptorMetodePembayaran adaptor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ActivityMetodePembayaran.this, SimpanDataPembayaran.class); // Start SimpanData activity
        ...
        StringRequest request = new StringRequest(
                        ...
                        try {
                            ...
                            if (jsonObject.has("data")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    model.add(new GetDataMetodePembayaran(
                                            getData.getString("id_pembayaran"),
                                            getData.getString("jenis_pembayaran"),
                                            getData.getString("keterangan")
                                    ));
                                }

                                adaptor = new AdaptorMetodePembayaran(ActivityMetodePembayaran.this, model, progressBar, ActivityMetodePembayaran.this);
                                listView.setAdapter(adaptor);
                                Log.d("Activity_admin", "Data loaded successfully");
                            } else {
                                Log.e("Activity_admin", "JSON does not contain 'data' key");
                                Toast.makeText(ActivityMetodePembayaran.this, "Invalid data format", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Log.e("Activity_admin", "JSON Parsing error: " + e.getMessage());
                            Toast.makeText(ActivityMetodePembayaran.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(ActivityMetodePembayaran.this, "Terjadi kesalahan saat memuat data", Toast.LENGTH_SHORT).show();
                        // Reload data on error
                        reloadData();
                    }
                });
