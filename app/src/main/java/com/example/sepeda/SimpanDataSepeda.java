...
public class SimpanDataSepeda extends AppCompatActivity {

    private EditText uploadNama;
    ...
    private void simpanData() {
        ...
        // Validasi input
        if (nama.isEmpty()) {
            Toast.makeText(SimpanDataSepeda.this, "Harap isi semua kolom", Toast.LENGTH_SHORT).show();
            return;
        }

        // URL untuk skrip PHP yang akan menyimpan data
        String url = new Configurasi().baseUrl() + "sepeda/simpan.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(SimpanDataSepeda.this, "Data berhasil disimpan", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SimpanDataSepeda.this, "Gagal menyimpan data", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
