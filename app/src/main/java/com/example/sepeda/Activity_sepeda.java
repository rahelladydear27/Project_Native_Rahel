...
import com.example.eldestapp.Adaptor;
...
public class Activity_sepeda extends AppCompatActivity implements AdaptorSepeda.DataChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Activity_sepeda.this, SimpanDataSepeda.class); // Start SimpanData activity
    ...
    private void loadData() {
        String url = new Configurasi().baseUrl() +"sepeda/tampil_data_sepeda.php";
        ...
        StringRequest request = new StringRequest(
                        ...
                        try {
                            ...
                            if (jsonObject.has("data")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    model.add(new GetDataSepeda(
                                            getData.getString("id_sepeda"),
                                            getData.getString("nama_sepeda")
                                    ));
                                }

                                adaptor = new AdaptorSepeda(Activity_sepeda.this, model, progressBar, Activity_sepeda.this);
                                listView.setAdapter(adaptor);
                                Log.d("Activity_admin", "Data loaded successfully");
                            } else {
                                Log.e("Activity_admin", "JSON does not contain 'data' key");
                                Toast.makeText(Activity_sepeda.this, "Invalid data format", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Log.e("Activity_admin", "JSON Parsing error: " + e.getMessage());
                            Toast.makeText(Activity_sepeda.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(Activity_sepeda.this, "Terjadi kesalahan saat memuat data", Toast.LENGTH_SHORT).show();
                        // Reload data on error
                        reloadData();
                    }
                });
