...
public class ActivityPetugas extends AppCompatActivity implements AdaptorPetugas.DataChangeListener {
    ...
    private AdaptorPetugas adaptor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ActivityPetugas.this, SimpanDataPetugas.class); // Start SimpanData activity
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.has("data")) {
                                ...
                                adaptor = new AdaptorPetugas(ActivityPetugas.this, model, progressBar, ActivityPetugas.this);
                                listView.setAdapter(adaptor);
                                Log.d("Activity_admin", "Data loaded successfully");
                            } else {
                                Log.e("Activity_admin", "JSON does not contain 'data' key");
                                Toast.makeText(ActivityPetugas.this, "Invalid data format", Toast.LENGTH_SHORT).show();
                            }
